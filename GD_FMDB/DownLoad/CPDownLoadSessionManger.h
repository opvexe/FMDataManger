...
@protocol CPDownLoadSessionMangerDelegate <NSObject>
...
@interface CPDownLoadSessionManger : NSObject<NSURLSessionDownloadDelegate>
/**
 *  <#Description#>
 */
 ...
 *  <#Description#>
 */
@property(nonatomic,weak)id <CPDownLoadSessionMangerDelegate>delegate;
/**
 *  最在下载数
 */
